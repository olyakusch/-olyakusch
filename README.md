...
> Відкрити цю сторінку в [https://olyakusch.github.io/-olyakusch/](https://olyakusch.github.io/-olyakusch/)
...
* шукайте **https://github.com/olyakusch/-olyakusch** та імпортуйте

## Редагувати цей проект ![Значок статусу складання](https://github.com/olyakusch/-olyakusch/workflows/MakeCode/badge.svg)

Щоб відредагувати цей репозиторій у MakeCode.

* відкрийте [https://makecode.microbit.org/](https://makecode.microbit.org/)
* клацніть **Імпорт**, потім клацніть **URL-адреса імпорту**
* вставте **https://github.com/olyakusch/-olyakusch** і клацніть "Імпорт"
...
![Відрендерене подання блоків](https://github.com/olyakusch/-olyakusch/raw/master/.github/makecode/blocks.png)
